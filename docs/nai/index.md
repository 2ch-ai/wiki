...
Если предпочитаешь более подробные руководства, то можешь ознакомиться с гайдами в зависимости от твоей платформы: [NVidia](https://rentry.co/2ch_nai_guide) или [AMD](./install/amd.md).
...
Впрочем, не стоит отчаиваться, ведь существует такой механизм как [LoRA](./lora/index.md), который позволит тебе сгенерировать нужного тебе персонажа, даже если основная модель о нём не знает.
