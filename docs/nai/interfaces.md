...
%% Nodes
Q1["Что важнее: лёгкость в освоении или гибкость?"]:::question
...
[ComfyUI](https://github.com/comfyanonymous/ComfyUI) и [SwarmUI](https://github.com/mcmonkeyprojects/SwarmUI).
...
* [ComfyUI-Manager](https://github.com/Comfy-Org/ComfyUI-Manager) - менеджер расширений, must have для всех пользователей ComfyUI
...
## Fooocus
[Fooocus](https://github.com/lllyasviel/Fooocus) - это интерфейс, заточенный на лёгкость в освоении и использовании.

Особенности:

* Множество настроек скрыто по умолчанию
...
[SwarmUI](https://github.com/mcmonkeyprojects/SwarmUI) - это фронтенд-оболочка, работающая поверх ComfyUI, отличительной особенностью которой является поддержка Multi-GPU, а так же возможность организовывать удалённый доступ к системе сразу несколькими пользователям, используя гибкую систему прав (что нужно очень редко, если быть откровенным).
...
Обладает очень приятным интерфейсом - он сделан качественно, и в целом видна работа UI/UX-дизайнера.
...
В результате, вы можете строить комплексные workflow, используя систему нод по типу ComfyUI, но, при этом, вы можете скрыть всю лапшу за простой формой с парой полей, которые вы хотели бы настраивать.  
...
![](https://files.catbox.moe/ireoyo.jpg)
![](https://files.catbox.moe/000ub0.jpg)

Stability Matrix позволяет редактировать workflow через удобный GUI, предоставляя возможность добавлять последовательные шаги (Hires. fix, Upscale, ADetailer) с тонкой конфигурацией каждого шага и возможностью навешивать на них свои дополнительные модули, такие как ControlNet.
