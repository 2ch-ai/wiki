...
!!! warning "Все современные модели имеют размер контекста от 32к токенов и выше, так что ограничение по сути идёт со стороны железа, и информация про Rope не актуальна."
